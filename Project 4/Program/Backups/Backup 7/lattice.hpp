...
public:
    ...
    lattice(void);
    lattice(const unsigned n, const double t);
    ...
    void montecarlo(const unsigned long mc_cycles, const std::string folder);
...
private:
    ...
    void _output(std::ofstream& out_values, const unsigned long cycle, const double E, const double M_abs);
    ...
    void _output(std::ofstream& out_results, const double* averages, const unsigned long mc_cycles);
